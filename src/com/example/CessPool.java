...
public class CessPool {
	...
	public CessPool() {
		...
		skillz.add(new AttackSkill("Chain Lightning", 50, "Modifier", 200, 50, 0, "Attacks with 150% strength"));
		skillz.add(new AttackSkill("Onslaught", 50, "Modifier", 200, 50, 0, "Attacks with 150% strength"));
