...
public class PotionPanel extends JPanel{
	...
	public PotionPanel() {
		...
		potion1.setText("<html><h3 style=\"color:white;\">· Name :"+ CessPool.potionz.get(0).name +"<br>"
        		+"· Defence : "+ CessPool.potionz.get(0).defence+ "<br>"
        		+"· Intelligence : "+ CessPool.potionz.get(0).intelligence + "<br>"
        		+ "· Accuracy : "+ CessPool.potionz.get(0).accuracy + "<br>"
        		+ "· Speed : "+ CessPool.potionz.get(0).speed + "<br>"
		...
		potion2.setText("<html><h3 style=\"color:white;\">· Name :"+ CessPool.potionz.get(1).name +"<br>"
        		...
        		+"· Intelligence : "+ CessPool.potionz.get(1).intelligence + "<br>"
		...
		potion3.setText("<html><h3 style=\"color:white;\">· Name :"+ CessPool.potionz.get(2).name +"<br>"
        		...
        		+"· Intelligence : "+ CessPool.potionz.get(2).intelligence + "<br>"
		...
		potion4.setText("<html><h3 style=\"color:white;\">· Name :"+ CessPool.potionz.get(3).name +"<br>"
        		...
        		+"· Intelligence : "+ CessPool.potionz.get(3).intelligence + "<br>"
